...
- [ ] **Sheep (ID 12)** - 매턴 1 식량
  - 가장 간단한 패시브 심볼, 즉시 구현 가능

### 1.2 종교 시스템 (우선순위: 중간)
**예상 작업 시간: 2-3일**

**필요 기능:**
- 종교 심볼 식별 함수 (ID 15-18 체크)
- 빈칸 카운팅 로직
- 조건부 음수 식량 처리

**구현 순서:**
1. [ ] **Ritual (ID 14)** - 3턴 후 파괴, 3 경험치
   - Fish와 유사한 카운터 파괴 로직

2. [ ] **Hinduism (ID 17)** - +5 식량, +1 경험치, 인근 종교당 -50 식량
   - 가장 단순한 종교 심볼

3. [ ] **Islam (ID 18)** - +2 경험치, 인근 종교당 -50 식량
   - 경험치만 제공

4. [ ] **Protestantism (ID 15)** - 인근 심볼당 +2 식량, +1 경험치, 인근 종교당 -50 식량
   - 인근 심볼 카운팅 필요

5. [ ] **Buddhism (ID 16)** - 빈칸당 +3 식량, +1 경험치, 인근 종교당 -50 식량
   - 빈칸 카운팅 로직 추가 필요

6. [ ] **Temple (ID 19)** - 기본 1 식량, 인근 심볼 없으면 +5 식량, 인근 종교 있으면 +2 식량
   - 복잡한 조건부 로직
