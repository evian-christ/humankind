...
const translations: Record<Language, Record<string, string>> = {
    en: {
        ...
        'event.grain_tribute.name': 'Grain Tribute',
        'event.grain_tribute.desc': 'Gain 12 Food immediately.',
        'event.grain_tribute.availability': '-',
        'event.merchant_patronage.name': 'Merchant Patronage',
        'event.merchant_patronage.desc': 'Gain 10 Gold immediately.',
        'event.merchant_patronage.availability': '-',
        ...
        'event.border_raid.desc': 'Summon a barbarian unit.',
        'event.border_raid.availability': '-',
        'event.grassland_festival.name': 'Grassland Festival',
        'event.grassland_festival.desc': 'If you own at least 3 Grasslands, gain 8 Food and 4 Knowledge.',
    ...
    ko: {
        ...
        'event.grain_tribute.name': '곡물 공물',
        'event.grain_tribute.desc': '즉시 식량 12를 획득합니다.',
        'event.grain_tribute.availability': '-',
        'event.merchant_patronage.name': '상인의 후원',
        'event.merchant_patronage.desc': '즉시 골드 10을 획득합니다.',
        'event.merchant_patronage.availability': '-',
        'event.artifact_market_refresh.name': '유물 상단',
        'event.artifact_market_refresh.desc': '유물 상점을 새로고침 합니다.',
        'event.artifact_market_refresh.availability': '-',
        'event.border_raid.name': '야만인 소탕',
        'event.border_raid.desc': '야만인 유닛을 소환합니다.',
        'event.border_raid.availability': '-',
        'event.grassland_festival.name': '초원 축제',
        'event.grassland_festival.desc': '초원을 3개 이상 보유 중이면 식량 8과 지식 4를 획득합니다.',
        ...
        'knowledgeUpgrade.12.desc': '망각의 화로 3개. 소모하여 보드 위에 있는 심볼 1개씩 파괴.',
