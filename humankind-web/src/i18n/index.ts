...
const translations: Partial<Record<Language, Record<string, string>>> & Record<'en' | 'ko', Record<string, string>> = {
    en: {
        ...
        'knowledgeUpgrade.51.desc': 'Medieval symbols no longer appear. Unlocks all Modern symbols. Terrain symbols no longer appear. Expand the slot board three times.',
    ...
    ko: {
        ...
        'knowledgeUpgrade.51.desc': '중세 심볼이 더 이상 등장하지 않습니다. 현대 심볼을 모두 해금합니다. 지형 심볼이 더 이상 등장하지 않습니다. 슬롯 보드를 3회 확장합니다.',
