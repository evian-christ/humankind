...
const translations: Record<Language, Record<string, string>> = {
    en: {
        ...
        'pregame.demoSubtitle': 'A quick primer before you choose the difficulty.',
        ...
        'symbol.38.desc': 'Per 2 empty slots: +1 Knowledge.',
        ...
        'destroySelection.oblivionDesc': 'Choose 1 owned symbol to remove from your collection. On-destroy effects apply as in a spin. The relic is consumed after you confirm.',
    ...
    ko: {
        ...
        'destroySelection.oblivionDesc': '컬렉션에서 제거할 심볼 1개를 고릅니다. 스핀 중 파괴와 같이 파괴 시 효과가 적용됩니다. 확정 후 이 유물은 소모됩니다.',
