...
const translations: Partial<Record<Language, Record<string, string>>> & Record<'en' | 'ko', Record<string, string>> = {
    en: {
        ...
        'symbol.militia.name': 'Militia',
        'symbol.warrior.name': 'Warrior',
        'symbol.archer.name': 'Archer',
        'symbol.horseman.name': 'Horseman',
        'symbol.mercenary.name': 'Mercenary',
        ...
        'symbol.militia.desc': '+3 Military. Destroyed after 5 turns.',
        'symbol.warrior.desc': '+2 Military.',
        'symbol.archer.desc': '+1 Military; adjacent to Forest or Mountain: +3 Military.',
        'symbol.horseman.desc': '+1 Military; if there is an Enemy symbol on the board: +5 Military.',
        'symbol.mercenary.desc': '+4 Military; -2 Gold.',
        ...
        'knowledgeUpgrade.33.desc': 'Legacy military upgrade. No current effect.',
        'knowledgeUpgrade.48.name': 'Stirrups',
        'knowledgeUpgrade.48.desc': 'Legacy military upgrade. No current effect.',
        'knowledgeUpgrade.55.name': 'Ballistics',
        'knowledgeUpgrade.55.desc': 'Legacy military upgrade. No current effect.',
        'knowledgeUpgrade.62.name': 'Interchangeable Parts',
        'knowledgeUpgrade.62.desc': 'Legacy military upgrade. No current effect.',
    ...
    ko: {
        ...
        'symbol.militia.name': '민병대',
        'symbol.warrior.name': '전사',
        'symbol.archer.name': '궁수',
        'symbol.horseman.name': '기마병',
        'symbol.mercenary.name': '용병',
        ...
        'symbol.militia.desc': '군사력 +3. 5턴 후 파괴.',
        'symbol.warrior.desc': '군사력 +2.',
        'symbol.archer.desc': '군사력 +1; 숲 혹은 산 인접 시: 군사력 +3.',
        'symbol.horseman.desc': '군사력 +1; 보드 위 적 심볼이 있으면: 군사력 +5.',
        'symbol.mercenary.desc': '군사력 +4; 골드 -2.',
        ...
        'knowledgeUpgrade.33.desc': '레거시 군사 업그레이드입니다. 현재 효과 없음.',
        'knowledgeUpgrade.48.name': '등자',
        'knowledgeUpgrade.48.desc': '레거시 군사 업그레이드입니다. 현재 효과 없음.',
        'knowledgeUpgrade.55.name': '탄도학',
        'knowledgeUpgrade.55.desc': '레거시 군사 업그레이드입니다. 현재 효과 없음.',
