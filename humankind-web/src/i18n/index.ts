...
const translations: Record<Language, Record<string, string>> = {
    en: {
        ...
        'relic.3.desc': 'Destroys the symbol with the lowest Food production, +5 Gold; after 5 turns: removed.',
        ...
        'relic.10.desc': '+0.5 Food per empty slot on the board.',
        'relic.11.name': 'Çatalhöyük Goddess Statuette',
        'relic.11.desc': 'If 15 or more symbols on the board: +8 Food.',
    ...
    ko: {
        ...
        'relic.3.desc': '식량 생산량이 가장 낮은 심볼 파괴, 골드 +5; 5턴 후 파괴.',
        ...
        'relic.10.desc': '빈 슬롯 하나당 식량 +0.5.',
        'relic.11.name': '차탈회위크 여신상',
        'relic.11.desc': '보드에 심볼이 15개 이상이면: 식량 +8.',
