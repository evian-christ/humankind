...
const translations: Partial<Record<Language, Record<string, string>>> & Record<'en' | 'ko', Record<string, string>> = {
    en: {
        ...
        'knowledgeUpgrade.symbolDescAfter.9.archer': 'Legacy military upgrade. No current effect.',
        'knowledgeUpgrade.symbolDescAfter.22.warrior': 'Legacy military upgrade. No current effect.',
        'knowledgeUpgrade.symbolDescAfter.33.archer': 'Removes Archer from the selection pool and adds Crossbowman.',
        'knowledgeUpgrade.symbolDescAfter.48.warrior': 'Removes Warrior from the selection pool and adds Knight.',
        'knowledgeUpgrade.symbolDescAfter.55.crossbowman': 'Removes Crossbowman from the selection pool and adds Cannon.',
        'knowledgeUpgrade.symbolDescAfter.62.cavalry': 'Removes Knight from the selection pool and adds Infantry.',
        ...
        'knowledgeUpgrade.symbolDescAfter.35.warrior': 'Horse produces +3 Food and +4 Gold.',
        ...
        'event.kadesh_battle_escape.desc': 'Gain Food immediately.',
        ...
        'symbol.desert.desc': 'Destroys 1 random adjacent Resource, Luxury, or era symbol. When Desert destroys a symbol: +5 Food.',
        ...
        'symbol.warrior.desc': 'Legacy military symbol.',
        'symbol.archer.desc': 'Legacy military symbol.',
        'symbol.tracker_archer.desc': 'Ancient ranged unit. When adjacent to Forest: +1 Food.',
        'symbol.knight.desc': 'Legacy military symbol.',
        'symbol.cavalry.desc': 'Legacy military symbol.',
        'symbol.cavalry_corps.desc': 'Medieval melee unit.',
        'symbol.crossbowman.desc': 'Legacy military symbol.',
        'symbol.musketman.desc': 'Medieval melee unit.',
        'symbol.cannon.desc': 'Legacy military symbol.',
        'symbol.infantry.desc': 'Legacy military symbol.',
        ...
        'relic.1.desc': 'No current effect.',
        ...
        'knowledgeUpgrade.9.desc': 'Legacy military upgrade. No current effect.',
        'knowledgeUpgrade.11.name': 'Currency',
        'knowledgeUpgrade.11.desc': 'Unlocks Merchant symbol.',
        'knowledgeUpgrade.13.name': 'Horsemanship',
        'knowledgeUpgrade.13.desc': 'Adds Horse to the selection pool.',
        ...
        'knowledgeUpgrade.symbolDescAfter.7.desert':
            '+1 Gold; destroys 1 random adjacent Resource, Luxury, or era symbol. When Desert destroys a symbol: +10 Food.',
        ...
        'knowledgeUpgrade.symbolDescAfter.32.desert':
            '+2 Gold; destroys all adjacent Resource, Luxury, and era symbols. For each symbol destroyed by Desert: +20 Food.',
        ...
        'knowledgeUpgrade.33.desc': 'Removes Archer from the selection pool and adds Crossbowman.',
        'knowledgeUpgrade.48.name': 'Stirrups',
        'knowledgeUpgrade.48.desc': 'Removes Warrior from the selection pool and adds Knight.',
        'knowledgeUpgrade.55.name': 'Ballistics',
        'knowledgeUpgrade.55.desc': 'Removes Crossbowman from the selection pool and adds Cannon.',
        'knowledgeUpgrade.62.name': 'Interchangeable Parts',
        'knowledgeUpgrade.62.desc': 'Removes Knight from the selection pool and adds Infantry.',
        'knowledgeUpgrade.symbolDescAfter.54.desert':
            '+5 Gold; destroys all Resource, Luxury, and era symbols on the board. For each symbol destroyed by Desert: +30 Food.',
    ...
    ko: {
        ...
        'knowledgeUpgrade.symbolDescAfter.9.archer': '레거시 군사 업그레이드입니다. 현재 효과 없음.',
        'knowledgeUpgrade.symbolDescAfter.22.warrior': '레거시 군사 업그레이드입니다. 현재 효과 없음.',
        'knowledgeUpgrade.symbolDescAfter.33.archer': '선택 풀에서 궁수를 제거하고 석궁병을 추가합니다.',
        'knowledgeUpgrade.symbolDescAfter.48.warrior': '선택 풀에서 전사를 제거하고 기사를 추가합니다.',
        'knowledgeUpgrade.symbolDescAfter.55.crossbowman': '선택 풀에서 석궁병을 제거하고 대포를 추가합니다.',
        'knowledgeUpgrade.symbolDescAfter.62.cavalry': '선택 풀에서 기사를 제거하고 보병을 추가합니다.',
        ...
        'event.kadesh_battle_escape.desc': '즉시 식량을 획득합니다.',
        'event.kadesh_battle_escape.availability': '-',
        ...
        'symbol.desert.desc': '무작위 인접한 자원, 사치품, 시대 심볼 1개 파괴. 사막 효과로 심볼 파괴 시: 식량 +5.',
        ...
        'symbol.warrior.desc': '레거시 군사 심볼입니다.',
        'symbol.archer.desc': '레거시 군사 심볼입니다.',
        'symbol.tracker_archer.desc': '고대 원거리 유닛. 숲과 인접 시: 식량 +1.',
        'symbol.knight.desc': '레거시 군사 심볼입니다.',
        'symbol.cavalry.desc': '레거시 군사 심볼입니다.',
        'symbol.cavalry_corps.desc': '중세 근접 유닛.',
        'symbol.crossbowman.desc': '레거시 군사 심볼입니다.',
        'symbol.musketman.desc': '중세 근접 유닛.',
        'symbol.cannon.desc': '레거시 군사 심볼입니다.',
        'symbol.infantry.desc': '레거시 군사 심볼입니다.',
        ...
        'knowledgeUpgrade.symbolDescAfter.7.desert':
            '골드 +1; 무작위 인접한 자원, 사치품, 시대 심볼 1개 파괴. 사막 효과로 심볼 파괴 시: 식량 +10.',
        ...
        'knowledgeUpgrade.symbolDescAfter.32.desert':
            '골드 +2; 인접한 자원, 사치품, 시대 심볼 모두 파괴. 사막 효과로 심볼 파괴 시마다: 식량 +20.',
        ...
        'knowledgeUpgrade.33.desc': '선택 풀에서 궁수를 제거하고 석궁병을 추가합니다.',
        'knowledgeUpgrade.48.name': '등자',
        'knowledgeUpgrade.48.desc': '선택 풀에서 전사를 제거하고 기사를 추가합니다.',
        'knowledgeUpgrade.55.name': '탄도학',
        'knowledgeUpgrade.55.desc': '선택 풀에서 석궁병을 제거하고 대포를 추가합니다.',
        'knowledgeUpgrade.62.name': '교체식 부품',
        'knowledgeUpgrade.62.desc': '선택 풀에서 기사를 제거하고 보병을 추가합니다.',
        'knowledgeUpgrade.symbolDescAfter.54.desert':
            '골드 +5; 보드 위 자원, 사치품, 시대 심볼 모두 파괴. 사막 효과로 심볼 파괴 시마다: 식량 +30.',
