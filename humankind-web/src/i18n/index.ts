...
const translations: Record<Language, Record<string, string>> = {
    en: {
        ...
        'symbol.52.desc': '+2 Food per different terrain type placed.',
        ...
        'knowledgeUpgrade.16.desc': 'All Libraries become Universities. Base Knowledge production +2.',
        ...
        'knowledgeUpgrade.21.desc': 'Warrior adjacent to Sea becomes Caravel (+7 HP). Unlocks Gold Vein. Spices: +2 Food per terrain type; when adjacent to Rainforest: +2 Food and +3 Gold.',
    ...
    ko: {
        ...
        'symbol.52.desc': '배치 된 다른 지형 유형 하나당: 식량 +2.',
        ...
        'knowledgeUpgrade.16.desc': '모든 도서관이 대학으로 바뀝니다. 기본 지식 생산 +2.',
        ...
        'knowledgeUpgrade.21.desc': '전사가 바다와 인접하면 캐러벨로 변합니다(+7 체력). 황금 광맥을 해금합니다. 향신료: 지형 유형당 식량 +2, 열대우림 인접 시 식량 +2·골드 +3.',
