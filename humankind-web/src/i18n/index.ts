...
const translations: Record<Language, Record<string, string>> = {
    en: {
        ...
        'leader.shihuang.sub.desc': 'Each time you enter a new era, gain 2 Ancient Relic Debris and 1 Ancient Tribal Joining.',
        'leader.locked.name': '???',
        ...
        'knowledgeUpgrade.69.name': 'Globalization',
        'knowledgeUpgrade.69.desc': 'Gain 2 Ancient Tribe Joins.',
    ...
    ko: {
        ...
        'leader.shihuang.sub.desc': '새 시대마다 고대 유물 잔해 2개와 고대 부족 합류 1개를 획득합니다.',
        'leader.locked.name': '???',
        ...
        'knowledgeUpgrade.69.name': '세계화',
        'knowledgeUpgrade.69.desc': '고대 부족 합류 2개를 획득합니다.',
