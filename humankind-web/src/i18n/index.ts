...
const translations: Record<Language, Record<string, string>> = {
    en: {
        ...
        'symbol.internet.desc': 'While placed on the board, all symbols are considered adjacent.',
        ...
        'knowledgeUpgrade.69.desc': 'Unlocks Internet.',
        'knowledgeUpgrade.72.name': 'Colonialism',
        'knowledgeUpgrade.72.desc': 'Gain 3 Ancient Tribe Joins.',
        ...
        'knowledgeUpgrade.71.desc': 'Enemy units spawned by barbarian invasion have 50% reduced attack power for 3 turns.',
    ...
    ko: {
        ...
        'symbol.internet.desc': '보드 위에 배치되어 있으면, 보드 위 모든 심볼을 인접한 것으로 간주합니다.',
        ...
        'knowledgeUpgrade.69.desc': '인터넷을 해금합니다.',
        'knowledgeUpgrade.72.name': '식민주의',
        'knowledgeUpgrade.72.desc': '고대 부족 합류 3개를 획득합니다.',
        ...
        'knowledgeUpgrade.71.desc': '야만인 침입으로 추가된 적 유닛은 3턴 동안 공격력이 50% 감소합니다.',
