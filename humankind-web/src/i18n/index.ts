...
const translations: Partial<Record<Language, Record<string, string>>> & Record<'en' | 'ko', Record<string, string>> = {
    en: {
        ...
        'settings.resetProgress.hint': 'Clears saved runs, tutorial completion, and achievements.',
        'settings.resetProgress.button': 'Reset',
        'settings.resetProgress.confirmTitle': 'Reset game data',
        'settings.resetProgress.confirm': 'Reset all game data? Saved runs, tutorial completion, and achievements will be deleted. Settings will be kept.',
        ...
        'symbolPool.setSubtitle': '{count} equipped sets · {total} symbols',
        ...
        'symbolPool.setFooter': 'Equal probability = 1 / current pool size · Equipped sets and common symbols are available from the start · Press F3 to close',
        /** HUD 기본 생산 툴팁: 식량·골드·지식은 `food16x16.png` / `gold16x16.png` / `knowledge16x16.png` */
        'game.hudBaseProductionShort': 'Base production +{n}',

        // Pre-game: Demo / Difficulty
        ...
        'pregame.demoSubtitle': 'A quick primer before you choose a difficulty.',
        ...
        'pregame.demoTutorial.3': 'After turns and events, you gain chances to add new symbols. Favor symbols that help each other through adjacency, terrain, or destruction effects.',
        'pregame.demoTutorial.4': 'Every 10 turns, the people demand Food. If you cannot pay, the run ends, so keep your economy stable while scaling up.',
        'pregame.demoPlay': 'Play',
        'pregame.difficultySelect': 'Difficulty',
        'pregame.setupTitle': 'Prepare your run',
        'pregame.difficulty.normal': 'Normal',
        'pregame.difficulty.hard': 'Hard',
        'pregame.difficulty.pro': 'Pro',
        'pregame.symbolSet.title': 'My deck',
        'pregame.symbolSet.hint': 'Equip 8 owned sets. Their symbols enter the selection pool from the first turn.',
        'pregame.symbolSet.collection': 'Set collection',
        'pregame.symbolSet.previous': 'Previous sets',
        'pregame.symbolSet.next': 'Next sets',
        'pregame.symbolSet.equipped': 'Equipped',
        'pregame.symbolSet.equip': 'Equip',
        'pregame.symbolSet.remove': 'Remove',
        'pregame.symbolSet.unowned': 'Not owned',
        'pregame.symbolSet.emptySlot': 'Empty slot',
        'pregame.symbolSet.noSymbols': 'Symbols not assigned',
        'pregame.symbolSet.startRequired': 'Equip 8 sets to start.',
        'pregame.symbolSet.commonNote': 'Terrain and shared symbols are always available. Unowned sets cannot be equipped.',
        'pregame.startGame': 'Start game',
        'symbolSet.agriculture.name': 'Agriculture',
        'symbolSet.pastoralism.name': 'Pastoralism',
        'symbolSet.fisheries.name': 'Fisheries',
        'symbolSet.hunting.name': 'Hunting',
        'symbolSet.tropical.name': 'Tropical Farming',
        'symbolSet.trade.name': 'Trade',
        'symbolSet.faith.name': 'Faith',
        'symbolSet.scholarship.name': 'Scholarship',
        'symbolSet.reserve09.name': 'Unassigned set 09',
        'symbolSet.reserve10.name': 'Unassigned set 10',
        'symbolSet.reserve11.name': 'Unassigned set 11',
        'symbolSet.reserve12.name': 'Unassigned set 12',
        ...
        'knowledgeUpgrade.1.desc': 'Expand the slot board three times.',
        'knowledgeUpgrade.3.name': 'Pastoralism',
        'knowledgeUpgrade.3.desc': 'Plains produces 1 additional Food.',
        'knowledgeUpgrade.5.name': 'Agriculture',
        'knowledgeUpgrade.5.desc': 'Unlocks Corn.',
        'knowledgeUpgrade.26.name': 'Medieval Age',
        'knowledgeUpgrade.26.desc': 'Upgrades Mountain. Expand the slot board three times.',
        'knowledgeUpgrade.51.name': 'Modern Age',
        'knowledgeUpgrade.51.desc': 'Expand the slot board three times. Upgrades Mountain.',
    ...
    ko: {
        ...
        'settings.resetProgress.hint': '저장된 런, 튜토리얼 완료 여부, 도전과제를 삭제합니다.',
        'settings.resetProgress.button': '초기화',
        'settings.resetProgress.confirmTitle': '게임 데이터 초기화',
        'settings.resetProgress.confirm': '모든 게임 데이터를 초기화할까요? 저장된 런, 튜토리얼 완료 여부, 도전과제가 삭제됩니다. 설정값은 유지됩니다.',
        ...
        'symbolPool.setSubtitle': '장착 세트 {count}개 · 심볼 {total}종',
        ...
        'symbolPool.setFooter': '균등 확률 = 1 / 현재 심볼 풀 크기 · 장착 세트와 공통 심볼은 처음부터 등장 · F3으로 닫기',
        ...
        'pregame.demoSubtitle': '난이도를 고르기 전에 꼭 알아두면 좋은 핵심만 모았습니다.',
        ...
        'pregame.demoTutorial.3': '턴 진행 후 새 심볼을 얻을 기회가 옵니다. 인접, 지형, 파괴 효과가 서로 맞물리는 조합을 우선해서 고르세요.',
        'pregame.demoTutorial.4': '10턴마다 백성이 식량을 요구합니다. 지불하지 못하면 즉시 패배하니, 초반에는 안정적인 식량 기반을 먼저 만드세요.',
        'pregame.demoPlay': '플레이',
        'pregame.difficultySelect': '난이도',
        'pregame.setupTitle': '게임 준비',
        'pregame.symbolSet.title': '내 덱',
        'pregame.symbolSet.hint': '보유한 세트 8개를 장착하세요. 포함된 심볼은 첫 턴부터 선택 풀에 등장합니다.',
        'pregame.symbolSet.collection': '세트 컬렉션',
        'pregame.symbolSet.previous': '이전 세트 보기',
        'pregame.symbolSet.next': '다음 세트 보기',
        'pregame.symbolSet.equipped': '장착 중',
        'pregame.symbolSet.equip': '장착',
        'pregame.symbolSet.remove': '해제',
        'pregame.symbolSet.unowned': '미보유',
        'pregame.symbolSet.emptySlot': '빈 슬롯',
        'pregame.symbolSet.noSymbols': '소속 심볼 미설정',
        'pregame.symbolSet.startRequired': '게임을 시작하려면 세트 8개를 장착하세요.',
        'pregame.symbolSet.commonNote': '지형과 공통 심볼은 항상 등장합니다. 미보유 세트는 장착할 수 없습니다.',
        'pregame.startGame': '게임 시작',
        'symbolSet.agriculture.name': '농업',
        'symbolSet.pastoralism.name': '목축',
        'symbolSet.fisheries.name': '어업',
        'symbolSet.hunting.name': '수렵',
        'symbolSet.tropical.name': '열대농경',
        'symbolSet.trade.name': '무역',
        'symbolSet.faith.name': '신앙',
        'symbolSet.scholarship.name': '학문',
        'symbolSet.reserve09.name': '미정 세트 09',
        'symbolSet.reserve10.name': '미정 세트 10',
        'symbolSet.reserve11.name': '미정 세트 11',
        'symbolSet.reserve12.name': '미정 세트 12',
        ...
        'knowledgeUpgrade.1.desc': '슬롯 보드를 3회 확장합니다.',
        'knowledgeUpgrade.3.name': '목축업',
        'knowledgeUpgrade.3.desc': '평야의 식량 생산량이 1 증가합니다.',
        'knowledgeUpgrade.5.name': '농업',
        'knowledgeUpgrade.5.desc': '옥수수를 해금합니다.',
        'knowledgeUpgrade.26.name': '중세시대',
        'knowledgeUpgrade.26.desc': '산이 업그레이드됩니다. 슬롯 보드를 3회 확장합니다.',
        'knowledgeUpgrade.51.name': '현대 시대',
        'knowledgeUpgrade.51.desc': '슬롯 보드를 3회 확장합니다. 산이 업그레이드됩니다.',
