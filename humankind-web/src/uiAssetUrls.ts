/** `public/` 기준 UI 에셋 — Vite `BASE_URL` 접두 사용 */
...
export const CULTURE_RESOURCE_ICON_URL = `${BASE}assets/ui/culture16x16.png`;
export const MILITARY_RESOURCE_ICON_URL = `${BASE}assets/ui/militarypower16x16.png`;
export const INVENTORY_ICON_URL = `${BASE}assets/ui/inventory15x15.png`;
export const HISTORY_ICON_URL = `${BASE}assets/ui/history16x16.png`;
/** 유물 패널 제목 줄 아이콘 (Pixi) */
