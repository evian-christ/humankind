...
export const KNOWLEDGE_UPGRADE_CANDIDATES: Record<number, KnowledgeUpgrade> = {
    ...
    201: { id: 201, name: "Hunting", type: SymbolType.NORMAL, description: "Destroys 1 'Banana' for +10 Gold. 'Banana' no longer appears in shop.", sprite: "001.png" },
    ...
    207: { id: 207, name: "Jewelry", type: SymbolType.NORMAL, description: "'Stone' produces -0.5 Food but +1.5 Gold.", sprite: "007.png" },
