...
export const SYMBOLS: Record<number, SymbolDefinition> = {
    // ── Religion ──
    31: { id: 31, name: "Christianity", era: Era.SPECIAL, symbol_type: SymbolType.FRIENDLY, description: "Every spin: produces Food equal to the highest Food produced by an adjacent symbol this spin. Adjacent to a Religion symbol: -500 Food.", sprite: "", tags: ["religion"] },
    32: { id: 32, name: "Islam", era: Era.SPECIAL, symbol_type: SymbolType.FRIENDLY, description: "Every spin: gains Gold equal to 3× the total Knowledge produced by adjacent symbols this spin. Adjacent to a Religion symbol: -500 Food.", sprite: "", tags: ["religion"] },
    33: { id: 33, name: "Buddhism", era: Era.SPECIAL, symbol_type: SymbolType.FRIENDLY, description: "Every spin: +20 Food per empty slot on the board. Adjacent to a Religion symbol: -500 Food.", sprite: "", tags: ["religion"] },
    ...
    12: { id: 12, name: "Oral Tradition", era: Era.ANCIENT, symbol_type: SymbolType.FRIENDLY, description: "Destroyed after 10 spins. On destroy: +10 Knowledge per adjacent symbol.", sprite: "", tags: [] },
    ...
    35: { id: 35, name: "Barbarian", era: Era.ANCIENT, symbol_type: SymbolType.ENEMY, description: "Random penalty based on turn intensity (1~5).", base_attack: 5, base_hp: 10, sprite: "035.png", tags: ["unit"] },
    36: { id: 36, name: "Warrior", era: Era.ANCIENT, symbol_type: SymbolType.COMBAT, description: "Every 10 spins: -30 Food.", base_attack: 5, base_hp: 10, sprite: "", tags: ["unit"] },
    37: { id: 37, name: "Glowing Amber", era: Era.ANCIENT, symbol_type: SymbolType.FRIENDLY, description: "Every spin: +0 Food. After 3 spins: destroyed and opens relic selection.", sprite: "", tags: [] },
    38: { id: 38, name: "Stargazer", era: Era.ANCIENT, symbol_type: SymbolType.FRIENDLY, description: "Every spin: +3 Knowledge per empty slot.", sprite: "", tags: [] },
    ...
    201: { id: 201, name: "Stone Tablet", era: Era.ANCIENT, symbol_type: SymbolType.FRIENDLY, description: "Every spin: +5 Knowledge per relic owned.", sprite: "", tags: [] },
};
...
export const KNOWLEDGE_PRODUCING_IDS = new Set([10, 16, 17, 25, 26, 38, 201]);
