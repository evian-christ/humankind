...
export const SYMBOLS: Record<number, SymbolDefinition> = {
    ...
    3: { id: 3, name: "Cattle", era: Era.ANCIENT, symbol_type: SymbolType.FRIENDLY, description: "Every spin: +1 Food. +2 Food per adjacent Cattle.", sprite: "003.png" },
    4: { id: 4, name: "Banana", era: Era.ANCIENT, symbol_type: SymbolType.FRIENDLY, description: "Every spin: +3 Food. Destroyed after 6 spins.", sprite: "004.png" },
    5: { id: 5, name: "Fish", era: Era.ANCIENT, symbol_type: SymbolType.FRIENDLY, description: "Every spin: +1 Food. +3 Food if adjacent to Coast.", sprite: "005.png" },
    6: { id: 6, name: "Coast", era: Era.ANCIENT, symbol_type: SymbolType.FRIENDLY, description: "Every spin: +1 Food. +1 Gold per adjacent Coast.", sprite: "006.png" },
    7: { id: 7, name: "Stone", era: Era.ANCIENT, symbol_type: SymbolType.FRIENDLY, description: "Every spin: +1 Food, +1 Gold.", sprite: "007.png" },
    8: { id: 8, name: "Copper", era: Era.ANCIENT, symbol_type: SymbolType.FRIENDLY, description: "Every spin: +2 Gold. If exactly 3 Copper on the board: all Copper produce ×3.", sprite: "008.png" },
    9: { id: 9, name: "Farm", era: Era.ANCIENT, symbol_type: SymbolType.FRIENDLY, description: "Every spin: +2 Food. Adjacent Wheat and Rice produce double.", sprite: "009.png" },
    10: { id: 10, name: "Monument", era: Era.ANCIENT, symbol_type: SymbolType.FRIENDLY, description: "Every spin: +1 Knowledge.", sprite: "010.png" },
    11: { id: 11, name: "Oasis", era: Era.ANCIENT, symbol_type: SymbolType.FRIENDLY, description: "Every spin: +3 Food. +2 Food per adjacent empty slot.", sprite: "011.png" },
    ...
    13: { id: 13, name: "Tropical Farm", era: Era.ANCIENT, symbol_type: SymbolType.FRIENDLY, description: "Every spin: +2 Food. If adjacent to Banana: +4 Food and Banana's destroy timer resets.", sprite: "013.png" },
    14: { id: 14, name: "Pasture", era: Era.ANCIENT, symbol_type: SymbolType.FRIENDLY, description: "Every spin: +1 Food. Adjacent Cattle and Horse produce +2 extra Food.", sprite: "014.png" },
    15: { id: 15, name: "Quarry", era: Era.ANCIENT, symbol_type: SymbolType.FRIENDLY, description: "Every spin: +1 Food. If adjacent to Stone: +3 Gold. If adjacent to Copper: +2 Gold.", sprite: "015.png" },
    16: { id: 16, name: "Totem", era: Era.ANCIENT, symbol_type: SymbolType.FRIENDLY, description: "Every spin: +1 Food per Religion symbol anywhere on the board.", sprite: "016.png" },
    17: { id: 17, name: "Offering", era: Era.ANCIENT, symbol_type: SymbolType.FRIENDLY, description: "Every spin: -5 Food, +3 Knowledge.", sprite: "017.png" },
    18: { id: 18, name: "Omen", era: Era.ANCIENT, symbol_type: SymbolType.FRIENDLY, description: "Every spin: 50% chance +5 Food, 50% chance -3 Food.", sprite: "018.png" },
    19: { id: 19, name: "Campfire", era: Era.ANCIENT, symbol_type: SymbolType.FRIENDLY, description: "Every spin: +1 Food. After 10 spins: destroyed and adjacent symbols produce double food this spin.", sprite: "019.png" },
    20: { id: 20, name: "Pottery", era: Era.ANCIENT, symbol_type: SymbolType.FRIENDLY, description: "Every spin: stores +2 Food internally. On destroy: releases stored Food ×2.", sprite: "020.png" },
    21: { id: 21, name: "Tribal Village", era: Era.ANCIENT, symbol_type: SymbolType.FRIENDLY, description: "After 1 spin: immediately adds 2 random Ancient symbols. Then destroys self.", sprite: "021.png" },
    35: { id: 35, name: "Barbarian", era: Era.ANCIENT, symbol_type: SymbolType.ENEMY, description: "Random penalty based on turn intensity (1~5).", base_attack: 5, base_hp: 10, sprite: "035.png" },
    ...
    25: { id: 25, name: "Library", era: Era.CLASSICAL, symbol_type: SymbolType.FRIENDLY, description: "Every spin: +2 Knowledge. +2 Knowledge if adjacent to Scroll.", sprite: "" },
