...
export const SYMBOLS: Record<number, SymbolDefinition> = {
    // ── Religion ──
    31: { id: 31, name: "Christianity", type: SymbolType.RELIGION, description: "+Food equal to the highest Food produced by an adjacent symbol; adjacent to a Religion symbol: -50 Food.", sprite: "031.png", tags: [] },
    32: { id: 32, name: "Islam", type: SymbolType.RELIGION, description: "+2 Gold per adjacent symbol that produces Knowledge; adjacent to a Religion symbol: -50 Food.", sprite: "032.png", tags: [] },
    33: { id: 33, name: "Buddhism", type: SymbolType.RELIGION, description: "+2 Food per empty slot; adjacent to a Religion symbol: -50 Food.", sprite: "033.png", tags: [] },
    34: { id: 34, name: "Hinduism", type: SymbolType.RELIGION, description: "+5 Food and +5 Knowledge per symbol destroyed this turn; adjacent to a Religion symbol: -50 Food.", sprite: "034.png", tags: [] },

    // ── Normal ──
    1: { id: 1, name: "Wheat", type: SymbolType.NORMAL, description: "Every 6 turns: +6 Food; when adjacent to Grassland: counter +1.", sprite: "001.png", tags: [] },
    2: { id: 2, name: "Rice", type: SymbolType.NORMAL, description: "Every 12 turns: +15 Food; when adjacent to Grassland: counter +2.", sprite: "002.png", tags: [] },
    3: { id: 3, name: "Cattle", type: SymbolType.NORMAL, description: "+1 Food; when adjacent to Plains: +2 additional Food.", sprite: "003.png", tags: [] },
    4: { id: 4, name: "Banana", type: SymbolType.NORMAL, description: "+2 Food; 6 turns: destroyed; when adjacent to Rainforest: reset counter.", sprite: "004.png", tags: [] },
    5: { id: 5, name: "Fish", type: SymbolType.NORMAL, description: "When adjacent to Sea: +2 Food.", sprite: "005.png", tags: [] },
    6: { id: 6, name: "Sea", type: SymbolType.TERRAIN, description: "+1 Gold per 4 adjacent symbols.", sprite: "006.png", tags: [] },
    7: { id: 7, name: "Stone", type: SymbolType.NORMAL, description: "+1 Gold; when adjacent to Mountain: +2 additional Gold.", sprite: "007.png", tags: [] },
    8: { id: 8, name: "Copper", type: SymbolType.NORMAL, description: "+1 Gold; if exactly 3 Copper on board: x3 Gold production.", sprite: "008.png", tags: [] },
    9: { id: 9, name: "Grassland", type: SymbolType.TERRAIN, description: "+2 Food.", sprite: "009.png", tags: [] },
    10: { id: 10, name: "Monument", type: SymbolType.ANCIENT, description: "+5 Knowledge.", sprite: "010.png", tags: [] },
    11: { id: 11, name: "Oasis", type: SymbolType.TERRAIN, description: "+1 Food per 2 adjacent empty slots.", sprite: "011.png", tags: [] },
    ...
    13: { id: 13, name: "Rainforest", type: SymbolType.TERRAIN, description: "+1 Food.", sprite: "013.png", tags: [] },
    14: { id: 14, name: "Plains", type: SymbolType.TERRAIN, description: "+1 Food.", sprite: "014.png", tags: [] },
    15: { id: 15, name: "Mountain", type: SymbolType.TERRAIN, description: "+1 Food.", sprite: "015.png", tags: [] },
    16: { id: 16, name: "Totem", type: SymbolType.ANCIENT, description: "In a corner: +20 Knowledge.", sprite: "016.png", tags: [] },
    17: { id: 17, name: "Offering", type: SymbolType.ANCIENT, description: "-1 Food, +10 Knowledge.", sprite: "017.png", tags: [] },
    18: { id: 18, name: "Omen", type: SymbolType.ANCIENT, description: "50% chance for +3 Food, 50% chance for -1 Food.", sprite: "018.png", tags: [] },
    19: { id: 19, name: "Campfire", type: SymbolType.ANCIENT, description: "+1 Food; 10 turns: destroyed; on destroy: adjacent symbols x2 Food this turn.", sprite: "019.png", tags: [] },
    20: { id: 20, name: "Pottery", type: SymbolType.ANCIENT, description: "+3 Food stored per turn; on destroy: gain Food equal to stored Counter.", sprite: "020.png", tags: [] },
    ...
    24: { id: 24, name: "Crab", type: SymbolType.NORMAL, description: "When adjacent to Sea: +3 Food.", sprite: "024.png", tags: [] },
    25: { id: 25, name: "Library", type: SymbolType.NORMAL, description: "+7 Knowledge.", sprite: "025.png", tags: [] },
    26: { id: 26, name: "Pearl", type: SymbolType.NORMAL, description: "When adjacent to Sea: +3 Gold.", sprite: "026.png", tags: [] },
    27: { id: 27, name: "Desert", type: SymbolType.TERRAIN, description: "Destroys 1 random adjacent Normal or era symbol.", sprite: "027.png", tags: [] },
    28: { id: 28, name: "Forest", type: SymbolType.TERRAIN, description: "Per adjacent Forest: +1 Food.", sprite: "028.png", tags: [] },
    29: { id: 29, name: "Deer", type: SymbolType.NORMAL, description: "+1 Food; if 2 or more adjacent Forests: +2 Food.", sprite: "029.png", tags: [] },
    30: { id: 30, name: "Date", type: SymbolType.NORMAL, description: "+1 Food; when destroyed by Desert: +2 Food and adds Date.", sprite: "030.png", tags: [] },
    ...
    38: { id: 38, name: "Stargazer", type: SymbolType.NORMAL, description: "+2 Knowledge per empty slot.", sprite: "038.png", tags: ["expert"] },
    ...
    23: { id: 23, name: "Horse", type: SymbolType.NORMAL, description: "+1 Food, +1 Gold; when adjacent to Plains: +2 additional Food.", sprite: "023.png", tags: [] },
    40: { id: 40, name: "Barbarian Camp", type: SymbolType.ENEMY, description: "Every 8 turns: adds 1 random current era enemy combat unit; Destroyed; on destroy: adds Loot.", base_hp: 20, sprite: "040.png", tags: [] },
    ...
    // 47: Salt
    47: { id: 47, name: "Salt", type: SymbolType.NORMAL, description: "+1 Food per adjacent terrain symbol.", sprite: "-", tags: [] },
    // 48: Honey
