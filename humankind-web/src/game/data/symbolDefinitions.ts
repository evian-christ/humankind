 ...
 *   011.png=Cow(→Cattle), 013.png=Library, 022.png=Barbarian,
 *   023.png=Warrior, 024.png=Swordsman, 029.png=Campfire
...
export const SYMBOLS: Record<number, SymbolDefinition> = {
    ...
    11: { id: 11, name: "Warrior",        era: Era.ANCIENT, symbol_type: SymbolType.COMBAT,   description: "Every spin: +1 Food. Destroys adjacent Barbarian. +8 Food per Barbarian destroyed.",              sprite: "023.png", base_attack: 1 },
    12: { id: 12, name: "Barbarian",      era: Era.ANCIENT, symbol_type: SymbolType.ENEMY,    description: "Every spin: -3 Food. Every 12 spins: adds another Barbarian to the board.",                       sprite: "022.png", base_hp: 10 },
    13: { id: 13, name: "Scout",          era: Era.ANCIENT, symbol_type: SymbolType.FRIENDLY, description: "Every spin: +1 Food, +1 Knowledge. Every 8 spins: adds a random Era 1 symbol to your collection.", sprite: "" },
    14: { id: 14, name: "Settler",        era: Era.ANCIENT, symbol_type: SymbolType.FRIENDLY, description: "Every spin: +2 Food. After 12 spins: destroyed and replaced by City.",                            sprite: "" },
    ...
    18: { id: 18, name: "Pasture",        era: Era.ANCIENT, symbol_type: SymbolType.FRIENDLY, description: "Every spin: +1 Food. Adjacent Cattle and Horse produce +2 extra Food.",                           sprite: "" },
    ...
    32: { id: 32, name: "Iron",           era: Era.CLASSICAL, symbol_type: SymbolType.FRIENDLY, description: "Every spin: +2 Food, +2 Gold. If adjacent to Warrior: Warrior is upgraded to Swordsman.",       sprite: "" },
    33: { id: 33, name: "Swordsman",      era: Era.CLASSICAL, symbol_type: SymbolType.COMBAT,   description: "Every spin: +2 Food. Destroys adjacent Barbarian. +12 Food per Barbarian destroyed. Attacks twice.", sprite: "024.png", base_attack: 2 },
    ...
    42: { id: 42, name: "Colosseum",      era: Era.CLASSICAL, symbol_type: SymbolType.FRIENDLY, description: "Every spin: +3 Food. If adjacent to Warrior or Swordsman: +4 Food extra. -2 Food per adjacent empty slot.", sprite: "" },
    ...
    49: { id: 49, name: "Siege Tower",    era: Era.CLASSICAL, symbol_type: SymbolType.FRIENDLY, description: "Every spin: +2 Food. If adjacent to a symbol that produces 0 or negative Food: destroys it and gives +15 Food.", sprite: "" },
...
export const KNOWLEDGE_PRODUCING_IDS = new Set([10, 13, 16, 21, 35, 36, 41, 45, 47]);

/** Gold를 생산하는 심볼 ID 목록 */
export const GOLD_PRODUCING_IDS = new Set([6, 7, 8, 15, 19, 31, 32, 34, 37, 38, 39, 40, 44, 46, 48]);

/** City 심볼 ID (Settler가 변환되는 대상 - 현재 정의에 없으므로 나중에 추가) */
export const CITY_SYMBOL_ID = -1; // placeholder
