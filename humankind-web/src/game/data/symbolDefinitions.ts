...
export const SYMBOLS: Record<number, SymbolDefinition> = {
    ...
    6: { id: 6, name: "Sea", era: Era.ANCIENT, symbol_type: SymbolType.FRIENDLY, description: "Every spin: +10 Food. +10 Gold per adjacent Sea.", sprite: "006.png", tags: ["water"] },
    ...
    11: { id: 11, name: "Oasis", era: Era.ANCIENT, symbol_type: SymbolType.FRIENDLY, description: "Every spin: +7 Food per adjacent empty slot.", sprite: "011.png", tags: ["water"] },
    ...
    22: { id: 22, name: "Merchant", era: Era.ANCIENT, symbol_type: SymbolType.FRIENDLY, description: "Not in corner: stores gold equal to highest adjacent food prod. In corner: gains stored gold.", sprite: "022.png", tags: [] },
