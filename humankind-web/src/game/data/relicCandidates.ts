...
export const RELIC_CANDIDATES: Record<number, RelicCandidate> = {
    ...
    102: {
        id: 102,
        name: "수메르 점토 낫",
        description: "'밀', '쌀' 파괴 시 해당 스핀에 골드 +30 추가 제공.",
        cost: 1500,
        era: Era.ANCIENT,
    ...
    103: {
        id: 103,
        name: "가나안의 번제물",
        description: "획득 시 즉시 식량 +500. 매 스핀 빈 슬롯마다 식량 -10.",
        cost: 1200,
        era: Era.ANCIENT,
        effect_type: 'passive',
    ...
    107: {
        id: 107,
        name: "예리코의 점토 두개골",
        description: "'제단', '기념비' 심볼이 매 스핀 지식 +20 추가 생산.",
        cost: 2000,
        era: Era.ANCIENT,
        effect_type: 'passive',
    ...
    111: {
        id: 111,
        name: "괴베클리 테페의 짐승 뼈",
        description: "'목장' 근처에 있는 동물 심볼이 5% 확률로 잭팟(식량 +150) 터뜨림.",
        cost: 2100,
        era: Era.ANCIENT,
        effect_type: 'conditional',
    ...
    115: {
        id: 115,
        name: "막달레니안 뼈 낚싯바늘",
        description: "매 스핀마다 '물고기' 심볼이 골드 +10 생산 기능을 얻음.",
        cost: 1400,
        era: Era.ANCIENT,
        effect_type: 'passive',
