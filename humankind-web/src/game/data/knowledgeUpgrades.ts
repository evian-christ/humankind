...
export const KNOWLEDGE_UPGRADES: Record<number, KnowledgeUpgrade> = {
    ...
    3: { id: 3, name: "Irrigation", era: Era.ANCIENT, description: "All Grasslands produce triple Food instead of double.", sprite: "003.png" },
    ...
    7: { id: 7, name: "Horsemanship", era: Era.ANCIENT, description: "Unlocks Horse symbol. Plains base production +10.", sprite: "007.png" },
    ...
    9: { id: 9, name: "Celestial Navigation", era: Era.ANCIENT, description: "Unlocks Crab and Pearl symbols for selection.", sprite: "-" },
    10: { id: 10, name: "Mathematics", era: Era.ANCIENT, description: "Base Food +5, Base Gold +2, Base Knowledge +2.", sprite: "-" },
};
