...
export const SYMBOL_CANDIDATES: Record<number, SymbolDefinition> = {
    ...
    105: { id: 105, name: "Windmill", era: Era.MEDIEVAL, symbol_type: SymbolType.FRIENDLY, description: "Every spin: +30 Food. Adjacent Wheat and Grassland produce double.", sprite: "105.png", tags: ["building"] },
