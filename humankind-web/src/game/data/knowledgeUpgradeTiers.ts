...
export const KNOWLEDGE_UPGRADE_TIER_ROWS: { level: number; ids: readonly number[] }[] = [
    ...
    { level: 3, ids: [CHIEFDOM_UPGRADE_ID, ARCHERY_UPGRADE_ID, LAW_CODE_UPGRADE_ID, CURRENCY_UPGRADE_ID, SACRIFICIAL_RITE_UPGRADE_ID] },
    { level: 4, ids: [HORSEMANSHIP_UPGRADE_ID, SEAFARING_UPGRADE_ID] },
    { level: 5, ids: [IRRIGATION_UPGRADE_ID, WRITING_SYSTEM_UPGRADE_ID] },
    { level: 6, ids: [ARCHITECTURE_UPGRADE_ID, DRY_STORAGE_UPGRADE_ID, CELESTIAL_NAVIGATION_UPGRADE_ID] },
    { level: 7, ids: [TRACKING_UPGRADE_ID, THEOLOGY_UPGRADE_ID] },
    { level: 8, ids: [IRON_WORKING_UPGRADE_ID, MATHEMATICS_UPGRADE_ID] },
    ...
    { level: 13, ids: [MECHANICS_UPGRADE_ID, INQUISITION_UPGRADE_ID, MARITIME_TRADE_UPGRADE_ID] },
    { level: 14, ids: [FEUDAL_CORN_UPGRADE_ID, GUILD_UPGRADE_ID, EXPLORATION_UPGRADE_ID] },
    ...
    { level: 18, ids: [FORESTRY_UPGRADE_ID, PASTURE_MANAGEMENT_UPGRADE_ID, GUNPOWDER_UPGRADE_ID] },
    ...
    { level: 22, ids: [ELECTION_SYSTEM_UPGRADE_ID] },
    { level: 23, ids: [BALLISTICS_UPGRADE_ID, RESTRUCTURING_UPGRADE_ID, MODERN_AGRICULTURE_UPGRADE_ID] },
    ...
    { level: 26, ids: [ELECTRICITY_UPGRADE_ID, GLOBALIZATION_UPGRADE_ID] },
    { level: 27, ids: [] },
    { level: 28, ids: [INTERCHANGEABLE_PARTS_UPGRADE_ID] },
    { level: 29, ids: [] },
