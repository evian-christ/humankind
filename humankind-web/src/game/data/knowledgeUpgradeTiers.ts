...
export const KNOWLEDGE_UPGRADE_TIER_ROWS: { level: number; ids: readonly number[] }[] = [
    ...
    { level: 11, ids: [FISHERY_GUILD_UPGRADE_ID, THREE_FIELD_SYSTEM_UPGRADE_ID, PLANTATION_UPGRADE_ID] },
    { level: 12, ids: [TANNING_UPGRADE_ID, COMPASS_UPGRADE_ID, DESERT_STORAGE_UPGRADE_ID] },
    { level: 13, ids: [MECHANICS_UPGRADE_ID, INQUISITION_UPGRADE_ID, MARITIME_TRADE_UPGRADE_ID] },
    { level: 14, ids: [MILITARY_SCIENCE_UPGRADE_ID, FEUDAL_CORN_UPGRADE_ID, GUILD_UPGRADE_ID, EXPLORATION_UPGRADE_ID] },
    ...
    { level: 19, ids: [NATIONALISM_UPGRADE_ID, COLONIALISM_UPGRADE_ID] },
    { level: 20, ids: [MODERN_AGE_UPGRADE_ID] },
    { level: 21, ids: [OCEANIC_ROUTES_UPGRADE_ID] },
    { level: 22, ids: [STEAM_POWER_UPGRADE_ID, OASIS_RECOVERY_UPGRADE_ID] },
    ...
    { level: 26, ids: [ELECTION_SYSTEM_UPGRADE_ID, GLOBALIZATION_UPGRADE_ID] },
    { level: 27, ids: [ELECTRICITY_UPGRADE_ID] },
